...
struct imapper {
	unsigned int slot	: 16; /* the id of the slot containing input data */
	unsigned int user	: 16; /* the id of the user resource consuming data */
	unsigned int addr	: 16; /* the input mapper ram id */
	unsigned int next	: 16; /* the next input mapper ram id */
