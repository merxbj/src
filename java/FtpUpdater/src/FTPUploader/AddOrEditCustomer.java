...
public class AddOrEditCustomer extends JFrame implements ActionListener
{
	...
	private void addNewCustomerToMysql()
	{
		try
		{
			...
			FTPSyncMainWindow.insertToLog("Customer " + cName.getText() + " succesfully added to table", true);
	...
	public void updateCustomerSettings()
    {
		try
		{
			...
			FTPSyncMainWindow.insertToLog("Customer " + cName.getText() + " succesfully updated", true);
			CustomersPanel.queryCustomersList();
		}
		catch(Exception e)
		{
