...
namespace Integri.Indexer.PublicNameIndexing.Locating
{
    public class ProjectExplorer
    {
        public ProjectExplorer(List<PublicObject> publics)
        {
            ...
            this.locators = Utils.Discover<IReferenceLocator>();
            this.componentCache = new Dictionary<string, XmlElement>();
        }
        ...
        private IDictionary<string, XmlElement> componentCache;
        private List<PublicObject> publics;
        private List<IReferenceLocator> locators;
    }
}
